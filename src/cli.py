...
def main_slice():
    ...
    print()
    print("This is an investigation test - no zombies, no scavenging to")
    print("worry about, hunger/thirst are handled. Just work out the way")
    print("out: move around, look at things, search where it seems worth")
    print("searching, and use `remember` when you want to take stock.")
    print()
