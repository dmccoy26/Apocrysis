...
class WorldFact:
    ...
    milestone: bool
    statement: str
    # A.4.3 / audit 1a: the short player-facing handle for the
    # investigation checklist - "what you're looking into", 3-8 words,
    # player voice. `statement` is the full conclusion; `lead` is the
    # line item. Never schema vocabulary.
    lead: str = ""
    needs: tuple = ()
...
WORLD_FACTS = (
    ...
    WorldFact('DIS_MOVED_TOGETHER', 'disappearance', 1, False,
              ...
              lead="which way the people went",
    ...
    WorldFact('DIS_ROUTES_PREPARED', 'disappearance', 1, False,
              ...
              lead="whether the routes were made ready first",
    ...
    WorldFact('DIS_ORGANISED', 'disappearance', 1, True,
              ...
              lead="whether someone directed the exodus",
    ...
    WorldFact('DEAD_STAGES_DIFFER', 'dead', 2, False,
              ...
              lead="how far the disease has run",
    ...
    WorldFact('DEAD_CONTAINED_FIRST', 'dead', 2, False,
              ...
              lead="whether there was an outbreak before the exodus",
              needs=('DEAD_WERE_LOCALS',)),
    WorldFact('DEAD_REGIONAL_CRISIS', 'dead', 2, True,
              ...
              lead="how far the crisis reached",
              needs=('DIS_ORGANISED',)),
    WorldFact('DEAD_INFECTION_PREDATES_EVAC', 'dead', 2, True,
              ...
              lead="which came first - infection or evacuation",
    ...
    WorldFact('RESP_COMMS_CUT_DELIBERATE', 'response', 3, True,
              ...
              lead="why the valley went silent",
    ...
    WorldFact('RESP_CORDON_HELD_OUTSIDE', 'response', 3, False,
              ...
              lead="who was holding the cordon",
    ...
    WorldFact('RESP_PROTOCOL_SEVEN', 'response', 4, False,
              ...
              lead="the name of the operation",
    ...
    WorldFact('RESP_SEAL_SCHEDULED', 'response', 4, True,
              ...
              lead="when the seal was decided",
    ...
    WorldFact('RESP_ONE_COMMAND', 'response', 4, True,
              ...
              lead="who ordered both the rescue and the seal",
    ...
    WorldFact('RESP_CONTAINMENT_WORKED', 'response', 4, False,
              ...
              lead="how it's remembered from outside",
    ...
    WorldFact('RESP_STILL_MONITORED', 'response', 5, False,
              ...
              lead="whether anyone outside is listening",
              needs=('RESP_COMMS_CUT_DELIBERATE',)),
    WorldFact('RESP_A_POST_TRANSMITS', 'response', 5, True,
              ...
              lead="the signal still coming from inside",
    ...
    WorldFact('RESP_CONSOLIDATION_HELD', 'response', 5, False,
              ...
              lead="the consolidation point that never emptied",
              needs=('RESP_SEAL_SCHEDULED',)),
    WorldFact('RESP_PEOPLE_ALIVE', 'response', 5, True,
              ...
              lead="whether anyone is still alive here",
    ...
    WorldFact('RESP_THE_ORDER', 'response', 6, True,
              ...
              lead="the order itself, and its signature",
    ...
    WorldFact('RESP_THE_CHOICE', 'response', 6, False,
              ...
              lead="what the transmitter can still do",
